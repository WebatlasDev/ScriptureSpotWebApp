      ...
      return {
        ...
        author: commentary.Authors
          ? {
              ...
              birthYear: commentary.Authors.BirthYear,
              deathYear: commentary.Authors.DeathYear,
              nationality: commentary.Authors.Nationality,
              occupation: commentary.Authors.Occupation,
              religiousTradition: commentary.Authors.ReligiousTradition,
              biography: commentary.Authors.Biography,
              nicknameOrTitle: commentary.Authors.NicknameOrTitle,
              sermonsPreached: commentary.Authors.SermonsPreached,
              booksWritten: commentary.Authors.BooksWritten,
              readingLevel: commentary.Authors.ReadingLevel,
              isBook: commentary.Authors.IsBook,
