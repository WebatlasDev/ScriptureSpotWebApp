...
interface EnhancedBibleChapterCardProps extends BibleChapterCardProps {
  onSelect: (chapterNumber: number) => void;
  pending?: boolean;
  disabled?: boolean;
}

export default function BibleChapterCard({ chapter, version, bookSlug, onSelect, pending = false, disabled = false }: EnhancedBibleChapterCardProps) {
