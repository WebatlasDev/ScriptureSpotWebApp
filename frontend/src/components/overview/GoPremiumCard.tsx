...
import { CrownIcon } from '@/components/ui/phosphor-icons';
...
const cardBackground =
  'linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%), linear-gradient(132deg, rgba(40, 40, 40, 0.03) 62%, rgba(255, 215, 0, 0.33) 100%), linear-gradient(316deg, rgba(40, 40, 40, 0.02) 0%, rgba(255, 215, 0, 0.16) 100%), linear-gradient(31deg, rgba(255, 215, 0, 0.30) 0%, rgba(40, 40, 40, 0.03) 100%), linear-gradient(157deg, rgba(40, 40, 40, 0.05) 0%, rgba(255, 215, 0, 0.50) 100%), #121212';
const cardHoverBackground =
  'linear-gradient(0deg, rgba(0, 0, 0, 0.20) 0%, rgba(0, 0, 0, 0.20) 100%), linear-gradient(132deg, rgba(255, 215, 0, 0.03) 62%, rgba(40, 40, 40, 0.33) 100%), linear-gradient(316deg, rgba(255, 215, 0, 0.02) 0%, rgba(40, 40, 40, 0.16) 100%), linear-gradient(31deg, rgba(40, 40, 40, 0.30) 0%, rgba(255, 215, 0, 0.03) 100%), linear-gradient(157deg, rgba(255, 215, 0, 0.05) 0%, rgba(40, 40, 40, 0.50) 100%), #121212';
...
export default function GoPremiumCard({ isLoading = false }: GoPremiumCardProps) {
        ...
        <>
          <Box
            sx={{
              ...
              height: 42,
              padding: '9px',
              background: 'linear-gradient(45deg, #282828 0%, #FFD700 100%)',
